...
class Preprocessor2D(nn.Module):
    def __init__(self, params, img_size=(720, 1440)):
        ...
        if self.add_grid:
            ...
            # now shard:
            start_x = params.read_anchor_x
            end_x = start_x + params.read_shape_x
            start_y = params.read_anchor_y
            end_y = start_y + params.read_shape_y
