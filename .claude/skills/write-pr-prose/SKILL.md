---
name: write-pr-prose
description: Write or amend the title or description of an existing PR. Use whenever updating PR prose, including after pushing new commits to a branch with an open PR.
...
3. Apply with `gh pr edit <number>`.
