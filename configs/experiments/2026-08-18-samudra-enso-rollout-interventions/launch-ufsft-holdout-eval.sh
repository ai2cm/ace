...
JOB="${JOB:-samudra-enso-ufsft40-holdout-eval}"
...
gantry run \
  ...
  --description "UFS FT epoch-40: 99-IC holdout hindcasts 2002-2011, ocean-only, prescribed forcing" \
  ...
  -- python -I -m fme.ace.evaluator "${SCRIPT_PATH}/wave1_eval_configs/hybridufsft40-holdout.yaml"
