...
JOB_GROUP="v1124-ref"
EXISTING_RESULTS_DATASET="01KJDH03MTDEKKJX3PND17EADV"  # this contains the checkpoint to use for inference
...
gantry run \
    --name $JOB_NAME \
    --task-name $JOB_NAME \
    --description 'Run coupled inference with prediction loader' \
