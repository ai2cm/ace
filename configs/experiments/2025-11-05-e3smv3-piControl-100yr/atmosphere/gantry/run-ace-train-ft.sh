...
CONFIG_FILENAME="ace-train-ft-config.yaml"
...
JOB_GROUP="BK-v1124-ACE-E3SMv3-piControl-100yr-no-smooth-ocean-ft-energy"
...
EXISTING_DATASETS=01KCPT7B79YK6FDRX2KZEC6F27
...
for RS in $(seq 1 $N_RANDOM_SEED_RUNS); do
    ...
    EXPERIMENT_ID=$(
        gantry run $ALLOW_DIRTY \
          ...
          --dataset $EXISTING_DATASETS:/weights \
          --gpus $N_GPUS \
