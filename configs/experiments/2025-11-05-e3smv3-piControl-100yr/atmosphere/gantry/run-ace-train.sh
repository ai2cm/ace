...
CONFIG_FILENAME="ace-train-config-resume.yaml"
...
JOB_GROUP="BK-v1124-ACE-E3SMv3-piControl-100yr-energy-cs-debug-print-time"
...
EXISTING_DATASETS=01KHRDFJ899B3G2CZTSPMDFMSP
...
for RS in $(seq 1 $N_RANDOM_SEED_RUNS); do
    ...
    EXPERIMENT_ID=$(
        gantry run $ALLOW_DIRTY \
          ...
          --dataset $EXISTING_DATASETS:/resume_results \
          --gpus $N_GPUS \
