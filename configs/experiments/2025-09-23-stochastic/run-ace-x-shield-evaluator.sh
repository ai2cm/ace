...
# run_eval "ace-x-shield-eval-config-rs0-100-year.yaml" "$base_name-x-shield-n384-e1c9-era5-ft-20step-v2-eval-100-year-rs0"
# run_eval "ace-x-shield-only-eval-config-rs1.yaml" "$base_name-x-shield-only-n384-e1c9-1step-ft-20step-v2-eval-rs1"
