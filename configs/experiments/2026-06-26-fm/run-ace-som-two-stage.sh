...
SPIN_UP_CONFIG_FILENAME="${1:-run_configs/ace-paper-som-eq-dataCO2-10yr-sstslab-inference-config-4deg-spinup-1xCO2-ic1.yaml}"
MAIN_CONFIG_FILENAME="${2:-run_configs/ace-paper-som-eq-dataCO2-10yr-sstslab-inference-config-4deg-main-1xCO2-ic1.yaml}"
JOB_NAME="${3:-som-eq-dataCO2-10yr-sstslab-inference}"
