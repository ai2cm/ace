...
ZARR_PATH = (
    "gs://vcm-ml-intermediate/2025-10-15-cm4-piControl-200yr-ocean-no-smoothing.zarr"
)
YEAR_START = 311
                    ...
                    "merge": [
                        {
                            ...
                            "file_pattern": (
                                "2025-10-20-cm4-piControl-200yr-no-smoothing-coupled-ocean.zarr"
                            ),
                            "engine": "zarr",
                        },
                        {
                            "data_path": "/climate-default",
                            "file_pattern": (
                                "2025-10-15-cm4-piControl-200yr-ocean-no-smoothing.zarr"
                            ),
                            "engine": "zarr",
                        },
                    ]
                    ...
                    "merge": [
                        {
                            "data_path": "/climate-default",
                            "file_pattern": (
                                "2025-10-20-cm4-piControl-200yr-no-smoothing-coupled-"
...
def main():
    ...
    for year in range(YEAR_START, YEAR_END + 1):
        ...
        filename = os.path.join(
            OUTPUT_DIR,
            f"evaluator-config-updated-picontrol-yr{year:04d}.yaml",
        )
