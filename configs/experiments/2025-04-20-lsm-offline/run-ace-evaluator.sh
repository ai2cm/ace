...
JOB_NAME="ace2-cm4-lsm-evaluator-posemb"
JOB_GROUP="ace2-cm4-lsm"
EXISTING_RESULTS_DATASET="01JVTC0T2379W75R4WWYR01FNA"  # this contains the checkpoint to use for inference
...
gantry run \
    --name $JOB_NAME \
    --task-name $JOB_NAME \
    --description 'Run ACE evaluator for LM4  data' \
