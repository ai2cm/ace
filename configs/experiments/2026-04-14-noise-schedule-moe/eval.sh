...
JOB_NAME="test-bundle-denoising-moe-checkpoint"
...
EXISTING_RESULTS_DATASET=01KT4RXRV4SX73QN6W5B62GVM3
wandb_group=""
...
gantry run \
    ...
    --dataset $EXISTING_RESULTS_DATASET:/checkpoints/bundled_moe.ckpt  \
