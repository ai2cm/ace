...
JOB_NAME="xshield-downscaling-100km-to-3km-low-sigma-global-oversample-tropics-mult8"
CONFIG_FILENAME="train-prmsl-multivar-low-sigma-oversample-tropics.yaml"
