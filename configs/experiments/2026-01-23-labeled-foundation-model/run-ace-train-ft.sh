...
run_training() {
  ...
  gantry run \
    ...
    --dataset ${weight_dataset}:/pre-trained-weights \
    --budget ai2/climate \
    --system-python \
    --allow-dirty \
...
run_training "train-labeled-combined-foundation-model-multi-step-ft-era5-only.yaml" "train-combined-foundation-with-era5-1step-n512-e5c5-era5-only-correctors-multi-step-FTv2-label-pos-emb-only" "place_holder" "01KJTABN7XJCCA6ME6X3T1MPWC"
