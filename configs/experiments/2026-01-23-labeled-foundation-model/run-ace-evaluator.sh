...
JOB_NAME="label-foundation-model-multi-step-FT-ramped-random-co2-ic3-latest-ckpt"
...
CONFIG_FILENAME="ace-evaluator-config-c96-random-co2-ramped-sst-ic0003.yaml"
