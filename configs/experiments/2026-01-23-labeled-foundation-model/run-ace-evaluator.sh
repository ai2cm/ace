...
JOB_NAME="label-foundation-model-multi-step-FT-era5-only-amip-era5"
JOB_GROUP="foundation-model-era5"
EXISTING_RESULTS_DATASET="01KKAAN6V28QPQR0QWVGPG6FHV"  # this contains the checkpoint to use for inference
