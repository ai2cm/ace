...
export BEAKER_CLUSTER=${BEAKER_CLUSTER:-"ai2/titan ai2/jupiter ai2/saturn ai2/ceres"}
export BEAKER_PRIORITY=${BEAKER_PRIORITY:-high}

declare -A JOBS=(
  ["ace-train-config-4deg-AIMIP-nc-sfno-gmron-bs16-schedon.yaml"]="ace2-era5-train-4deg-AIMIP-nc-sfno-gmron-bs16-schedon"
  ["ace-train-config-4deg-AIMIP-nc-sfno-gmron-bs16-schedoff.yaml"]="ace2-era5-train-4deg-AIMIP-nc-sfno-gmron-bs16-schedoff"
  ["ace-train-config-4deg-AIMIP-nc-sfno-gmron-bs8-schedon.yaml"]="ace2-era5-train-4deg-AIMIP-nc-sfno-gmron-bs8-schedon"
  ["ace-train-config-4deg-AIMIP-nc-sfno-gmron-bs8-schedoff.yaml"]="ace2-era5-train-4deg-AIMIP-nc-sfno-gmron-bs8-schedoff"
  #["ace-train-config-4deg-AIMIP-swin-gmron.yaml"]="ace2-era5-train-4deg-AIMIP-swin-v2-gmron"
  #["ace-train-config-4deg-AIMIP-swin-gmroff.yaml"]="ace2-era5-train-4deg-AIMIP-swin-v2-gmroff"
  #["ace-train-config-4deg-AIMIP-nc-swin-gmron.yaml"]="ace2-era5-train-4deg-AIMIP-nc-swin-v2-gmron"
  #["ace-train-config-4deg-AIMIP-nc-swin-gmroff.yaml"]="ace2-era5-train-4deg-AIMIP-nc-swin-v2-gmroff"
