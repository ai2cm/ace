...
N_GPUS=4
PRETRAIN_DATASET="01JYGZSHY0Z7XGDC00T5NP6GXT"
...
run_training "train-baseline_amip_shield_finetune.yaml" "$base_name-baseline-1deg-amip-shield-areamse-finetune" "$stats_1deg_dataset"
