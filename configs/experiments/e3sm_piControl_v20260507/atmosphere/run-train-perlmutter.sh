...
# wandb config
export WANDB_NAME=PM-v0507-ACE-E3SMv3-piControl-1yr-train-rs1
export WANDB_RUN_GROUP=v0507-test

export COMMIT=$(git rev-parse --short HEAD)

export FME_TRAIN_DIR=/pscratch/sd/e/elynnwu/fme-dataset
export FME_STATS_DIR=/pscratch/sd/e/elynnwu/fme-dataset/2026-05-07-v3-LR-piControl-aigo-test4-stats
