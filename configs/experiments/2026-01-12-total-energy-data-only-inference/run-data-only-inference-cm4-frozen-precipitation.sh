...
JOB_NAME="2026-01-12-ace2-cm4-data-only-evaluator-frozen-precipitation"
JOB_GROUP="ace2-cm4"
EXISTING_RESULTS_DATASET="01K8TEC71GMW96SZSP5KHZCZW3"  # this contains the checkpoint to use for inference
...
JOB_NAME="2026-01-12-ace2-cm4-data-only-evaluator-frozen-precipitation-1pctCO2"
