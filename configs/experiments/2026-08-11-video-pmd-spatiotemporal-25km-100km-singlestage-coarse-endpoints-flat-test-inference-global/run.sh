...
#
# Output:
#   /climate-default/2026-06-25-temporal-diffusion/inference/video-pmd-spatiotemporal-25km-100km-global-5ch-singlestage-coarse-endpoints-flat/test-2023-2024-ens4-global.zarr
#
...
#
# Run:  bash configs/experiments/2026-08-11-video-pmd-spatiotemporal-25km-100km-singlestage-coarse-endpoints-flat-test-inference-global/run.sh
set -e
