...
CONFIG_FILENAME="fine-tune-xshield.yaml"
...
for seed in {0..0}; do
    ...
    job_name="ace2s-shieldplus-tune-xshield-10yr-2014val-seed${seed}"
    ...
    gantry run \
        ...
        --dataset ${PRMSL_SHIELDPLUS_TUNED[$seed]}:training_checkpoints/best_inference_ckpt.tar:/ckpt.tar \
