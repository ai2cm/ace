...
ZARR_PATH="gs://vcm-ml-experiments/2025-11-hiro-manuscript-results/global/Global_perfect_2023.zarr"
OUTPUT_DIR="/climate-default/2026-08-03-hiro-ace-v2-outputs/2026-08-03-hiro-perfect-pred-global-2023/perfect_prediction_hiro_v1_precip_only_histograms"
...
submit_histogram_job() {
    ...
    gantry run \
        --name "$job_name" \
        --description "Compute histograms over 1 year of perfect prediction HiRO v1 2023" \
        --workspace ai2/ace \
        --priority normal \
        --cluster ai2/phobos \
        --gpus 0 \
...
submit_histogram_job "hiro-v1-perfect-pred-histograms-prate-2023" PRATEsfc
