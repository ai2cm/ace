...
run_training "train-4deg-daily-combined-shield-era5-label-pooled.yaml"        "combined-shield-era5-label-pooled-rs0"        1
#   F: no labels, ERA5-only stats — normalization sensitivity
