...
DATE="2026-04-13"
CONFIG_FILENAME="ace-amip-data-only-evaluator-full-period-config.yaml"
...
for ensemble_id in "ic_0001" "ic_0002"; do
    ...
    job_name="${DATE}-amip-${ensemble_id}-data-only-full-period-evaluator"
    gantry run \
        --name $job_name \
        --description 'Run ACE AMIP data-only evaluator 1940-2020' \
