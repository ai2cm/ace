...
JOB_NAME="xshield-downscaling-100km-to-3km-v1-full-field-save-with-staticinput"
CONFIG_FILENAME="resume-v1.yaml"
...
PREVIOUS_RESULTS_DATASET="01KBCJ14CVYXMCAVQAJPTANVSX"
