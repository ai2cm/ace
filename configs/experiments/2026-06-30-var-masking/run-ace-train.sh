...
run_training "${1:-ace-train-config-4deg-nc-sfno-c96-mask10-co2default.yaml}" "${2:-ace2-var-mask-nc-sfno-c96-mask10-co2default-v1}" "${3:-ace2-var-masking-2026-06-30}"
