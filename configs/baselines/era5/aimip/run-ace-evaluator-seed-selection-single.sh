...
JOB_NAME_BASE="ace-aimip-trend-evaluation-start-2009"
JOB_GROUP="ace-aimip-trend-evaluation-start-2009"
...
# ACE2_ERA5_NOISE_CONDITIONED_SNFO_UPDATED_CHECKPOINT_IDS="01KG8EMSZPMXEZ742JZJZ0WXVF 01KG8D0K2P8D23DAT5GY0EAZ37 01KGG7B7H7B2PVMXZ3CA9DCR19 01KGG3TYGHADY9ETJ2CQP34ZYF"
# ACE2_ERA5_AIMIP_PERIOD_CHECKPOINT_IDS="01KGAQ6VR4JDPHYDSFBX8Y1F7Q 01KGH5GE3G71GVNPZQBMEYZTJ8 01KGH50JFA11VZW0KJ1SD9PMFD 01KGGJQ8N0SGPQ6CRWRFRQ5H1W"
...
# ACE2_1_ERA5_FULL_ERA5_CHECKPOINT_IDS="01KGGW8DNWS5GMENMTTNTSH193 01KGGJQ82KE8JVMJFMNG9063CH 01KGH9YP63QGJF0J9MY54M7J17 01KGEK5AMCKSRF0ZJWZH5Z3KWA"
...
declare -A ALL_CHECKPOINT_ID_ENSEMBLES=(
  ...
  # ["ACE2-ERA5-noise-conditioned-SNFO-updated"]=$ACE2_ERA5_NOISE_CONDITIONED_SNFO_UPDATED_CHECKPOINT_IDS \
  # ["ACE2-ERA5-AIMIP-period"]=$ACE2_ERA5_AIMIP_PERIOD_CHECKPOINT_IDS \
  # ["ACE2-ERA5-AIMIP-ff"]=$ACE2_ERA5_AIMIP_FF_CHECKPOINT_IDS \
  # ["ACE2-ERA5-AIMIP-res"]=$ACE2_ERA5_AIMIP_RES_CHECKPOINT_IDS \
  # ["ACE2-1-ERA5-full-ERA5"]=$ACE2_1_ERA5_FULL_ERA5_CHECKPOINT_IDS \
...
GROUP_ORDER=(
  ...
  # "ACE2-ERA5-noise-conditioned-SNFO-updated" \
  # "ACE2-ERA5-AIMIP-period" \
  # "ACE2-ERA5-AIMIP-ff" \
  # "ACE2-ERA5-AIMIP-res" \
  # "ACE2-1-ERA5-full-ERA5" \
