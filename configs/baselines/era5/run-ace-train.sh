...
# run_training "ace-train-config-1-step-pretrain-no-weighting-32-noise-embed-dim-energy-and-frozen-precip-corrector-on.yaml" "$base_name-era5-1-step-pre-training-no-channel-weightings-32-noise-embed-dim-energy-and-frozen-precip-corrector-on-rs2"
# run_training "ace-train-config-multi-step-ft-ace-train-config-multi-step-ft-no-weighting-32-noise-embed-dim-energy-corrector-on.yaml" "$base_name-era5-multi-step-ft-no-channel-weightings-32-noise-embed-dim-energy-and-frozen-precip-corrector-on-rs2"
run_training "ace-train-config-multi-step-ft-ace-train-config-multi-step-ft-no-weighting-32-noise-embed-dim-energy-corrector-on.yaml" "$base_name-era5-multi-step-ft-no-channel-weightings-32-noise-embed-dim-energy-and-frozen-precip-corrector-on-new-order-rs2"
