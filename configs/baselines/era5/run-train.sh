#!/bin/bash
#
# ACE ERA5 baseline training launcher.
...
#   ./run-train.sh 2-step-bptt     # launch only calls matching the substring
...
run_training "ace-train-config-2-step-bptt-pretrain-daily-fg16-sr0p125.yaml" "ace2s-era5-daily-fg16-sr0p125-2-step-bptt-pretrain-rs0" 4
