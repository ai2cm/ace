...
| `train-config.yaml` | Example SamudrACE stage 1 training config, generated by `train.sh` |
| `finetune-config-template.yaml` | SamudrACE stage 2 training config template |
| `finetune-config.yaml` | Example SamudrACE stage 2 training config, generated by `finetune.sh` |
