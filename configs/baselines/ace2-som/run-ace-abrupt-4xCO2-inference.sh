...
JOB_NAME="ace-abrupt-4xCO2-inference-ensemble"  # recommended but not required to change this
CONFIG_FILENAME="ace-abrupt-4xCO2-inference-ensemble-config.yaml"
...
gantry run \
    --name $JOB_NAME \
    --description 'Run ACE abrupt 4xCO2 inference ensemble' \
