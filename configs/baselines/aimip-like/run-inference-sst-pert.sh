...
JOB_NAME_BASE="ace2s-4deg-daily-era5-only-rs0-shared-t-append-clipped"
JOB_GROUP="ace-global-mean-removed-sst-perts"
# this is from ace-aimip-fine-tune-decoder-pressure-levels-separate-decoder-lr-warmup-RS0
EXISTING_RESULTS_DATASET="01KSJTTQZYB35XDFCA0AWH76VC"
