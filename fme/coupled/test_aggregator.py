...
def test_inference_logs_labels_exist(tmpdir):
    ...
    expected_keys = [
        ...
        "time_mean/smallest_scale_norm_bias/ocean_var",
        "time_mean/positive_norm_bias/ocean_var",
        "time_mean/negative_norm_bias/ocean_var",
        "time_mean/mean_abs_norm_bias/ocean_var",
        ...
        "time_mean/smallest_scale_norm_bias/atmos_var",
        "time_mean/positive_norm_bias/atmos_var",
        "time_mean/negative_norm_bias/atmos_var",
        "time_mean/mean_abs_norm_bias/atmos_var",
