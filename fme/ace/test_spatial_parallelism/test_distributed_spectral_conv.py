...
from fme.ace.models.modulus.layers import MLP, DropPath, RealFFT2, SpectralAttention2d, InverseRealFFT2
from fme.ace.models.modulus.s2convolutions import SpectralAttentionS2, SpectralConvS2
...
from test_helper import gather_helper_conv, split_helper_conv, relative_error, _split_helper, _gather_helper, init_seed
...
def test_distributed_spectral_conv():
  ...
  with torch.no_grad():
    weight = split_helper_conv(spect_conv_local.weight, hdim=-2, wdim=None, w_group=w_group, h_group=h_group)
  ...
  #############################################################
  with torch.no_grad():
    wgrad_gather_full = gather_helper_conv(wgrad_local, hdim=-2, wdim=None, w_group=w_group, h_group=h_group)
