...
class InferenceStepper(abc.ABC):
    @property
    @abc.abstractmethod
    ...
    def set_train(self):
        """
        Set the stepper to training mode.
        """
        ...
    ...
    def set_eval(self):
        """
        Set the stepper to evaluation mode.
        """
        ...


class TrainStepper(abc.ABC):
    @property
    @abc.abstractmethod
    def inference(self) -> InferenceStepper: ...
