...
class CrossFormerStepConfig(StepConfigABC):
    ...
    Parameters:
        ...
        atmosphere_level_start: Starting index for atmosphere levels.
...
class CrossFormerStep(StepABC):
    ...
    def __init__(
        ...
        super().__init__()
        # surface before atmosphere to match in_names ordering
        ...
        # 1. normalizer is the __init__ parameter — already available
