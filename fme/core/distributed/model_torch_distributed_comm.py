...
"""
This file contains comm utilities borrowed from the following link:
https://github.com/NVIDIA/makani/blob/dbcf2c1dc82cdbc544c81193eecd8ac4a6be337c/makani/utils/comm.py.

NOTE: This file is kept intentionally identical to the upstream Makani source
      (link above) to simplify future syncs. Linting is suppressed accordingly.

NOTE: model_torch_distributed_comm.py:199: DeprecationWarning:
      DistributedManager.create_groups_from_config is no longer
      the most simple way to organize process groups.
      Please switch to DeviceMesh, and DistributedManager.initialize_mesh
