...
Originally copied from https://github.com/microsoft/aurora/blob/ab2afd6962fb1c6e4f2c5b99e3657f063831ace1/aurora/batch.py
"""
...
class Batch:
    ...
    Args:
        surf_vars (dict[str, :class:`torch.Tensor`]): Surface-level variables with shape
            `(b, t, h, w)`.
        static_vars (dict[str, :class:`torch.Tensor`]): Static variables with shape `(b, t, h, w)`.
