...
from ..models import CheckpointModelConfig, DiffusionModel, SerialPredictorConfig
from ..predictors import PatchPredictionConfig, PatchPredictor, SerialPredictor
...
class Downscaler:
    ...
    ) -> DiffusionModel | SerialPredictor | PatchPredictor:
        """
