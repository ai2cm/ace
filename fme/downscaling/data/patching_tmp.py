...
"""
Temporary copies of functions from fme.downscaling.patching that are used
by the patching methods on batch objects in fme.downscaling.data.datasets,
moved to avoid circular imports.
Will be deleted when the PatchPredictor is refactored out of patching.py,
then the circular imports from the datasets module will be gone.
"""
