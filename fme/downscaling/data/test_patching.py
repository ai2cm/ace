...
from fme.downscaling.data import PairedBatchData, StaticInput
...
def test_paired_patches_with_random_offset_consistent(overlap):
    ...
    topography = StaticInput(data=topography_data, coords=full_fine_coords[0])
    y_offsets = []
    x_offsets = []
...
def test_paired_patches_shuffle(shuffle):
    ...
    topography = StaticInput(data=topography_data, coords=fine_coords)
