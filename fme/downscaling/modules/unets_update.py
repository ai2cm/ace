...
class SongUNet(_SongUNet):
    def __init__(self, img_resolution: int, *args, **kwargs):
        ...
        check_level_compatibility(
            img_resolution, self.channel_mult, self.attn_resolution
        )
    ...
    __init__.__signature__ = inspect.signature(_SongUNet.__init__)  # type: ignore
    forward.__doc__ = _SongUNet.forward.__doc__
    forward.__signature__ = inspect.signature(_SongUNet.forward)  # type: ignore
