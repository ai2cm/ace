"""
Performance-optimized version of physicsnemo_unets_v2/benchmark.py.

Adapted for SongUNetv3, with amp_mode removed from constructors.
"""
...
class SongUNetv3BenchmarkBf16(SongUNetv3Benchmark):
    @classmethod
    def new(cls) -> Self:
        return cls._new_with_params(
            img_resolution=64,
...
class SongUNetv3BenchmarkApex(SongUNetv3Benchmark):
    @classmethod
    def new(cls) -> Self:
        return cls._new_with_params(
            img_resolution=512,
...
class SongUNetv3BenchmarkApexBf16(SongUNetv3Benchmark):
    @classmethod
    def new(cls) -> Self:
        return cls._new_with_params(
            img_resolution=512,
...
register_benchmark("songunetv3_bf16")(SongUNetv3BenchmarkBf16)
register_benchmark("songunetv3_apex")(SongUNetv3BenchmarkApex)
register_benchmark("songunetv3_apex_bf16")(SongUNetv3BenchmarkApexBf16)
