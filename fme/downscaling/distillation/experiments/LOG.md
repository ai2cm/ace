...
| `TBD` | 2026-07-13 | …-prate-spectral-gamma0p5 | `TBD` | `TBD` | fdistill, spectral W=1e-2, **band_gamma=0.5** (gentle hi tilt; lo≈0.61× hi≈1.37×) | launching | ⏳ | [report](reports/2026-07-13-prate-spectral-gamma0p5-TBD.md) |
| `TBD` | 2026-07-13 | …-prate-spectral-gamma1 | `TBD` | `TBD` | fdistill, spectral W=1e-2, **band_gamma=1** (linear hi tilt; lo≈0.33× hi≈1.7×) | launching | ⏳ | [report](reports/2026-07-13-prate-spectral-gamma1-TBD.md) |
