...
class GraphCastNet(Module):
    ...
    def __init__(
        ...
        res_latitude: int = 721,
        res_longitude: int = 1440,
        ...
        self.latitudes = torch.linspace(-90, 90, steps=res_latitude)
        self.longitudes = torch.linspace(-179.75, 180, steps=res_longitude)
    ...
    def set_checkpoint_processor(self, checkpoint_segments: int):
        # checkpoint the intermediate processor part
        # with the potential for individual segments
        self.processor.set_checkpoint_segments(checkpoint_segments)

    def set_checkpoint_encoder(self, checkpoint_flag: bool):
        # checkpoint the encoder, the embedder for all the encoder
        # inputs and the first layer of the processor
        self.encoder_checkpoint_fn = set_checkpoint_fn(checkpoint_flag)

    def set_checkpoint_decoder(self, checkpoint_flag: bool):
        # checkpoint the decoder, the remaining decoder
        # and the last layer of the processor
    ...
    def custom_forward(self, grid_nfeat):
        (
            mesh_efeat_processed,
            mesh_nfeat_processed,
            grid_nfeat_encoded,
        ...
        # checkpoint of processor now done in processor itself
    ...
    def to(self, *args, **kwargs):
        """Unified to method for graphs and the model"""
