...
# helpers
from .layers import trunc_normal_, DropPath, MLP
from .layers import SpectralAttentionS2, SpectralConvS2
from .layers import SpectralAttention2d, SpectralConv2d
...
class FourierNeuralOperatorNet(modulus.Module):
    def __init__(
        self,
        params=None,
        ...
        self.img_size = (
            ...
            if hasattr(params, "img_crop_shape_x")
            and hasattr(params, "img_crop_shape_y")
            else img_size
        )
        self.scale_factor = (
        ...
        if self.spectral_transform == "sht":
            ...
            # we introduce some ad-hoc rescaling of the weights to aid
