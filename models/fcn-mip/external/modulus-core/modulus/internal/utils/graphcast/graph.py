...
class Graph:
    def __init__(self, icospheres_path, lat_lon_grid, dtype=torch.float):
        self.dtype = dtype
    ...
    def create_mesh_graph(self, verbose=True):
    ...
    def create_g2m_graph(self, verbose=True):
    ...
    def create_m2g_graph(self, verbose=True):
