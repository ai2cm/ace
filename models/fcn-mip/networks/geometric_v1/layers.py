...
class RealFFT2(nn.Module):
    ...
    def forward(self, x):
        ...
        for xt in xs:
            ...
            ys.append(torch.cat((yt[..., :math.ceil(self.lmax/2), :self.mmax], yt[..., -math.floor(self.lmax/2):, :self.mmax]), dim=-2))
...
class InverseRealFFT2(nn.Module):
    ...
    def forward(self, x):
        ...
        ys = []
        for xt in xs:
            ys.append(torch.fft.irfft2(xt, dim=(-2, -1), s=(self.nlat, self.nlon), norm="ortho"))
