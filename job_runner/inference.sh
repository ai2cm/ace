...
while read TRAIN_EXPER; do
    ...
    python -m $FME_MODULE_VALIDATE --config_type inference "$CONFIG_PATH_REL" --override $OVERRIDE_ARGS
    ...
    if [[ "$DRY_RUN" != "true" ]]; then
        ...
        gantry run \
            ...
            -- python -I -m $FME_MODULE_INFERENCE "$CONFIG_PATH_REL" --override $OVERRIDE_ARGS
        echo
    fi
done <"$INPUT_PATH"
