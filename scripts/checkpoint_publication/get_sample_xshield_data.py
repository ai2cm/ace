...
DEFAULT_INPUT_URL = (
    "gs://vcm-ml-intermediate/2025-09-16-X-SHiELD-AMIP-1deg-8layer-11yr.zarr"
)
OUTPUT_PATH = "./data/sample_era5_data"
DEFAULT_FORCING_START_TIME = "2014"
DEFAULT_FORCING_END_TIME = "2024"
...
if __name__ == "__main__":
    ...
    ds = ds.rename({"grid_yt": "latitude", "grid_xt": "longitude"})
    ...
    for year in IC_YEARS:
        for month in range(1, 13):
            ...
            time = cftime.DatetimeJulian(
                year, month, 1, start_hour, 0, 0, 0, has_year_zero=False
            )
