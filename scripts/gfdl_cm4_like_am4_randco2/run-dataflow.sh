...
# --member, --num-timesteps, --output-path) and beam pipeline options can be
# appended after the config argument.
COMMON_ARGS=(
    --config "$CONFIG"
    --runner="$RUNNER"
)
...
DATAFLOW_ARGS=(
    ...
    --temp_location gs://vcm-ml-scratch/jamesd/cm4-randco2-sea-surface-2026-08-17/temp/
